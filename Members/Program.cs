...
namespace Members
{
    class Program
    {
        ...
        {
            StreamWriter file = new StreamWriter("c:\\repo\\plik.txt",true);
            try
            {
            ...
            using (StreamWriter file2 = new StreamWriter("c:\\repo\\plik.txt",true))    // instrukcja using sama wykonuje zwolnienie zasobów file.close
            {
